//===---- ColossusTargetMachine.h - Define the Colossus TargetMachine -----===//
...
//===----------------------------------------------------------------------===//
//
// This file declares the Colossus specific subclass of TargetMachine.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_COLOSSUS_COLOSSUSTARGETMACHINE_H
...
public:
  ...
  const ColossusSubtarget *getSubtargetImpl(const Function &) const override;
