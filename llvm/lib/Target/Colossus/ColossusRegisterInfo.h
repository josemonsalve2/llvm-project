//===-- ColossusRegisterInfo.h - Colossus Register Information --*- C++ -*-===//
...
#ifndef LLVM_LIB_TARGET_COLOSSUS_COLOSSUSREGISTERINFO_H
#define LLVM_LIB_TARGET_COLOSSUS_COLOSSUSREGISTERINFO_H
...
struct ColossusRegisterInfo : public ColossusGenRegisterInfo {
public:
  ColossusRegisterInfo();
