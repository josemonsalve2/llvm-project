...
//===----------------------------------------------------------------------===//
//
// This file declares Colossus Graphcore TargetInfo objects.
//
//===----------------------------------------------------------------------===//
...
static const unsigned ColossusAddrSpaceMap[] = {
    0, // Default
    1, // opencl_global
    3, // opencl_local
    4, // opencl_constant
...
static const int ColossusDWARFAddrSpaceMap[] = {
...
public:
  ...
  const llvm::omp::GV &getGridValue() const override {
    return llvm::omp::ColossusGridValues;
  }
  ...
  getDWARFAddressSpace(unsigned AddressSpace) const override {
    if (AddressSpace >= llvm::array_lengthof(ColossusDWARFAddrSpaceMap) ||
        ColossusDWARFAddrSpaceMap[AddressSpace] < 0)
      return llvm::None;
    return ColossusDWARFAddrSpaceMap[AddressSpace];
  }
