...
void CGOpenMPRuntimeColossus::emitTargetOutlinedFunction(
  ...
  if (Mode)
    ...
    llvm_unreachable("Execution mode is not supported");
...
void CGOpenMPRuntimeColossus::emitCriticalRegion(
    ...
    const Expr *Hint) {
  llvm_unreachable("Critical regions not supported in this architecture");
}
...
void CGOpenMPRuntimeColossus::emitReduction(
    ...
    ArrayRef<const Expr *> ReductionOps, ReductionOptionsTy Options) {
      assert(false && "Reductions are not supported in this architecture yet");
}
